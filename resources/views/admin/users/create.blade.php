...
<div class="page_content">
    ...
    <h1 class="heading_title">{{__('admin.users.create.title')}}</h1>
    ...
    <div class="form">
        <form class="form-horizontal" method="post" action="{{route('admin.add_user')}}">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" value="{{old('first_name')}}" class="form-control" id="first_name" name="first_name" placeholder="{{__('admin.users.feilds.first_name')}}">
                </div>
            </div>
            <div class="form-group">
                <label for="input0" class="col-sm-2 control-label bring_right left_text">{{__('admin.users.feilds.second_name')}}</label>
                <div class="col-sm-10">
                    <input type="text" value="{{old('second_name')}}" class="form-control" id="second_name" name="second_name" placeholder="{{__('admin.users.feilds.second_name')}}">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" value="{{old('last_name')}}" class="form-control" id="last_name" name="last_name" placeholder="{{__('admin.users.feilds.last_name')}}">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="email" value="{{old('email')}}" class="form-control" id="email" name="email" placeholder=" {{__('admin.users.feilds.email')}}">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" value="{{old('mobile')}}" class="form-control" id="mobile" name="mobile" placeholder=" {{__('admin.users.feilds.mobile')}}">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" value="{{old('country')}}" class="form-control" id="country" name="country" placeholder=" {{__('admin.users.feilds.first_name')}}">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" value="{{old('city')}}" class="form-control" id="city" name="city" placeholder=" {{__('admin.users.feilds.city')}}">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="radio" {{old('gender') == 1 ? 'checked' : ''}} id="gender" name="gender"  value="1"> {{__('admin.users.feilds.male')}}
                    <input type="radio" {{old('gender') == 0 ? 'checked' : ''}} id="gender" name="gender"  value="0"> {{__('admin.users.feilds.female')}}
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="radio" {{old('role') == 'user' ? 'checked' : ''}} id="role" name="role"  value="user"> {{__('admin.users.feilds.user')}}
                    <input type="radio" {{old('role') == 'admin' ? 'checked' : ''}} id="role" name="role"  value="admin"> {{__('admin.users.feilds.admin')}}
                </div>
            </div>
